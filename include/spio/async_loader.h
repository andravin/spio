...
namespace spio
{
    ...
    template <class Input_, class SmemInput_, int CHUNK_H_, int THREADS_>
    class AsyncLoader
    {
    public:
        ...
        __device__ AsyncLoader(uint4 *smem_in, const uint4 *in, int block_x, int block_c8)
        {
            ...
            {
                // TODO: Modify Tensor class to define the corresponding Index class.
                // TODO: Use the Index class to fold the index into its dimensions.
