...
namespace spio
{
    ...
    {
    public:
        constexpr static int _D0_Stride = _D1;
        ...
        constexpr Index2D _d0(int d0) { return Index2D(_offset + d0 * _D0_Stride); }

        constexpr int _d0() { return _offset / _D0_Stride; }
        constexpr int _d1() { return _offset % _D1; }
    ...
    {
    public:
        constexpr static int _D1_Stride = _D2;
        constexpr static int _D0_Stride = _D1 * _D2;
        ...
        constexpr Index3D _d1(int d1) { return Index3D(_offset + d1 * _D1_Stride); }
        constexpr Index3D _d0(int d0) { return Index3D(_offset + d0 * _D0_Stride); }

        constexpr int _d2() { return _offset % _D2; }
