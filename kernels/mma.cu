...
extern "C"
{
    ...
    __global__ void mma_m16_n8_k8_test(
    ...
    /// @param C 16m x 8n matrix with float32 elements.
    __global__ void mma_m16_n8_k16_test(
        float2 *__restrict__ C,
        const __half2 *__restrict__ A,
        const __half2 *__restrict__ B_trans)
    {
